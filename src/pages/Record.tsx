            ...
            <TabsContent value="tickets">
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                <div className="relative flex-1">
                  ...
                  <input
                    type="text"
                    placeholder="Search tickets by name, email, reference..."
                    value={ticketSearch}
                  ...
                  <table className="w-full text-sm">
                    <thead className="bg-muted">
                      <tr>
                        ...
                        <th className="text-left px-4 py-3 font-semibold text-foreground">Qty</th>
                    ...
                    <tbody className="divide-y divide-border">
                      {filteredTicketPurchases.map((t) => (
                        <tr key={t.id} className="hover:bg-muted/50 transition">
                          ...
                          <td className="px-4 py-3 text-foreground font-semibold">₦{(t.amount / 100).toLocaleString()}</td>
              ...
              <div className="mt-4 flex justify-between text-sm text-muted-foreground">
                <span>Total: {filteredTicketPurchases.length} records</span>
                <span>
                  Revenue: ₦
                  {(filteredTicketPurchases.filter((t) => t.status === "paid").reduce((sum, t) => sum + t.amount, 0) / 100).toLocaleString()}
                </span>
              </div>
            </TabsContent>
